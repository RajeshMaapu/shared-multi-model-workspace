    ...
    public static let tools: [Tool] = [
        ...
        Tool(name: "workshop_report_result",
             ...
             inputSchema: obj(["task_id": s, "subtask_id": s, "summary": s,
                              ...
                              required: ["task_id", "subtask_id", "summary", "generation"])),
        ...
        Tool(name: "workshop_acquire_lease",
             description: "Acquire a named resource lease (browser/computer-use registry). CAS takeover allowed when expired; returns generation.",
             inputSchema: obj(["task_id": s, "resource": s, "ttl_seconds": i, "url": s],
                              required: ["resource"])),
        Tool(name: "workshop_renew_lease",
             description: "Renew a resource lease you hold at the given generation.",
             inputSchema: obj(["resource": s, "generation": i, "ttl_seconds": i],
                              required: ["resource", "generation"])),
        Tool(name: "workshop_release_lease",
             description: "Release a resource lease you hold at the given generation.",
             inputSchema: obj(["resource": s, "generation": i],
                              required: ["resource", "generation"])),
    ]
